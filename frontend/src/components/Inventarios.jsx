          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Formato esperado: Código, Descripción, Laboratorio, Precio Full, Precio con Descuento
              </p>
            </div>
            <Button 
                ...
                <table className="w-full table-auto">
                  <thead>
                    <tr className="border-b">
                      ...
                      <th className="text-left py-2">Precio Full</th>
                      <th className="text-left py-2">Precio Descuento</th>
                  ...
                  <tbody>
                    {filteredInventarios.map((item) => (
                      <tr key={item.id} className="border-b">
                        ...
                        <td className="py-2">${item.precio_full.toFixed(2)}</td>
                        <td className="py-2">${item.precio_descuento.toFixed(2)}</td>
